...
#dfn=conn.read(spreadsheet="https://docs.google.com/spreadsheets/d/1Z0clIbSazOxcYwngdQGK557s-ltIQ-Al_Ja5ypl2fgw",worksheet="Sheet1",ttl="10")
dfn=conn.read(worksheet="Sheet1",ttl="10")
...
if st.button('Show Results'):
  ...
  for i in range(1,n+1):           
   L=H+str(i)
   ii=str(i)           
   L=conn.read(spreadsheet="https://docs.google.com/spreadsheets/d/1Z0clIbSazOxcYwngdQGK557s-ltIQ-Al_Ja5ypl2fgw",worksheet=Well_ID+"_"+ii,ttl="10")
   ...
   AVG["SEP_Pressure"]=AVG1.mean()           
   AVG["SEP_Temperature"]=AVG2.mean()           
   AVG["FLP"]=AVG3.mean()           
   AVG["FLT"]=AVG4.mean()          
   AVG["Gas_Rate"]=AVG5.mean()           
   AVG["Water"]=AVG6.mean()           
   AVG["Condensate"]=AVG7.mean()           
   AVG["GOR"]=AVG8.mean()           
   AVG["API"]=AVG9.mean()           
   AVG["BS&W"]=AVG10.mean()
